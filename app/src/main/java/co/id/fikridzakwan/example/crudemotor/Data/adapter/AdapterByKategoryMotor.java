...
public class AdapterByKategoryMotor extends RecyclerView.Adapter<AdapterByKategoryMotor.ViewHolder> {

    private final Context context;
    private final List<MotorData> motorDataList;

    public AdapterByKategoryMotor(Context context, List<MotorData> motorDataList) {
