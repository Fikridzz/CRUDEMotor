...
public class AdapterPopolerMotor extends RecyclerView.Adapter<AdapterPopolerMotor.ViewHolder> {

    private final Context context;
    private final List<MotorData> motorDataList;

    public AdapterPopolerMotor(Context context, List<MotorData> motorDataList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_motor_populer, parent, false));
    }
